...
<img src="./Data/imgs/trade/tradewrite.png" alt="거래소 글쓰기" style="zoom: 33%;" />
...
- 유저들이 자신의 섬을 공유할 수 있는 자랑게시판을 추가하였습니다. 로그인을 하여 글을 쓸 수 있도록 하였습니다.  

- 댓글을 통해 유저끼리 의견을 교환할 수 있도록 하였습니다. 이미지 업로드는 파이어베이스를 사용하여 이미지를 저장하고 받아오도록 하였습니다.
