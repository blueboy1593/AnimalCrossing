...
#### 1) 트렌드 동향
  ...
  - 게임 이용 정보와 커뮤니티를 찾는 유저 또한 증가 추세
...
- 이를 통해, 정보와 커뮤니티 서비스를 한 곳에서 제공하는 사이트를 착안
...
- 사이트를 이용하려고 유입되는 유저들에게 지속적으로 광고를 노출시킴으로써 서비스를 유지하기 위한 안정적 수익 확보
